...
@app.callback(
    dash.dependencies.Output(component_id='graphs',
                             component_property='children'),
    [dash.dependencies.Input(component_id='vehicle-data-name',
                             component_property='value')],
    events=[dash.dependencies.Event(component_id='graph-update',
