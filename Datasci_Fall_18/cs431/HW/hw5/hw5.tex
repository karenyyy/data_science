...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n}{department} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{departments.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{,}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{class} \PY{n+nc}{DataSqlLoader}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{dsl} \PY{o}{=} \PY{n}{DataSqlLoader}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{cs431\PYZus{}project}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{n}{select} \PY{n}{e}\PY{o}{.}\PY{n}{lastname} \PY{k}{as} \PY{n}{LAST}\PY{p}{,} \PY{n}{e}\PY{o}{.}\PY{n}{firstname} \PY{k}{as} \PY{n}{FIRST}\PY{p}{,} \PY{n}{e}\PY{o}{.}\PY{n}{cellphone} \PY{k}{as} \PY{n}{CELL}\PY{p}{,}
               \PY{n}{s}\PY{o}{.}\PY{n}{date} \PY{k}{as} \PY{n}{DATE}\PY{p}{,} \PY{n}{d}\PY{o}{.}\PY{n}{department\PYZus{}name} \PY{k}{as} \PY{n}{DEPT}\PY{p}{,} \PY{n}{date\PYZus{}format}\PY{p}{(}\PY{n}{s}\PY{o}{.}\PY{n}{start\PYZus{}time}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{I}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{p}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)} 
            \PY{k}{as} \PY{n}{START}\PY{p}{,} \PY{n}{s}\PY{o}{.}\PY{n}{shift\PYZus{}length} \PY{k}{as} \PY{n}{SHIFT\PYZus{}LENGTH}
        ...
        \PY{n}{order} \PY{n}{by} \PY{n}{LAST}\PY{p}{,} \PY{n}{FIRST}\PY{p}{,} \PY{n}{DATE}\PY{p}{,} \PY{n}{DEPT}\PY{p}{,} \PY{n}{START} \PY{n}{asc} \PY{n}{limit} \PY{l+m+mi}{50}\PY{p}{;}
\end{Verbatim}

    \paragraph{display results}\label{display-results}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{query} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}\PYZsq{}\PYZsq{}}
        ...
        \PY{l+s+s1}{       date\PYZus{}format(s.start\PYZus{}time, }\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{I}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{p}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{) as START, s.shift\PYZus{}length as SHIFT\PYZus{}LENGTH}
        ...
        \PY{l+s+s1}{order by LAST, FIRST, DATE, START, SHIFT\PYZus{}LENGTH, DEPT asc limit 50;}
